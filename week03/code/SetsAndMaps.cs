...
public static class SetsAndMaps
{
    ...
    public static Dictionary<string, int> SummarizeDegrees(string filename)
    {
        ...
        foreach (var line in File.ReadLines(filename))
        {
            ...
            var degree = fields[3]; // Degree is in the 4th column (index 3)
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        // Create dictionary to count characters in first word
        ...
        // Check second word against the character counts
    ...
    public static string[] EarthquakeDailySummary()
    {
        ...
        // Create array of formatted strings for each earthquake
